...
\begin{frame}[t,fragile]{Antecedentes}
    ...
    \begin{purpleblock}{Brecha}
        \footnotesize Métricas \textbf{servo-mecánicas} (MSE) que no consideran el impacto \textbf{morfológico} en el rendimiento (\textit{yield}); existe el proceso inverso en \cite{Lam2015_Fingerprint} pero no ofrece un enfoque predictivo.
    \end{purpleblock}
\end{frame}

\begin{frame}[fragile]{Hipótesis y objetivos}
    \begin{purpleblock}{Hipótesis}
        Una CNN entrenada sobre datos industriales, usada como función de costo, permite seleccionar parámetros cinemáticos de trayectorias de cuarto orden que \textbf{minimicen la probabilidad de defecto} sujeto a una \textbf{restricción de productividad} (\cite{Kim2017_Market,Kim2019_Productivity}).
    \end{purpleblock}
