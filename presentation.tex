...
\begin{frame}[fragile]{La CNN como puente: clase $\to$ costo}
    ...
    {\footnotesize Sólo las clases inducibles por servo (\textit{none, scratch, edge-local, random}) contribuyen a $\mathcal{J}$. Pesos $w_c$ por clase: literatura (\cite{Kim2019_Productivity,Yang2018_Yield}) o calibración.}
    \end{center}
\end{frame}
