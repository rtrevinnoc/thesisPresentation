...
\begin{frame}{Trajectory Reference Generation}
    \begin{contentblock}{StepperController}
    A Python-based \texttt{StepperController} generates reference states.
    \end{contentblock}
    \begin{itemize}
        \item Wafer stage constant scanning velocity: $v_{w,scan} = 0.8$ m/s
        \item Reticle stage velocity: $v_{r,scan} = 3.2$ m/s (4:1 demagnification ratio)
        \item Max acceleration for wafer transients: $a_{w,max} = 20$ m/s$^2$
        \item Evaluates centripetal and Coriolis effects during fast turnarounds.
    \end{itemize}
\end{frame}
...
\begin{frame}{Next Steps}
    \begin{itemize}
        \item Design yield-aware higher-order scanning trajectories.
        \item Inject proposed trajectories into the MuJoCo simulation.
        \item Analyze overlay performance and residual settling time.
        \item Compare with classical S-curve and low-order polynomials.
    \end{itemize}
    \vspace{0.5cm}
    \begin{center}
