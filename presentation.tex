...
\begin{frame}[t,fragile]{Antecedentes --- análisis de literatura}
    \footnotesize PRISMA 2020--2025 $\cdot$ 1\,180 artículos $\to$ 12 incluidos $\cdot$ póster IEEE LARS/LARC 2025 (\cite{Trevino2025_LARSPoster}).
...
\begin{frame}[fragile]{Hipótesis y objetivos}
    \begin{purpleblock}{Hipótesis}
        Una CNN entrenada sobre WM-811K, usada como función de costo, permite seleccionar parámetros cinemáticos de trayectorias de cuarto orden que \textbf{minimicen la probabilidad de defecto} sujeto a una \textbf{restricción de productividad} (\cite{Kim2017_Market,Kim2019_Productivity}).
    \end{purpleblock}
